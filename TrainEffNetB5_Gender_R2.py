...
model_dir = '/media/SSD/BearHouse-Person-Model/models/B5R1_Gender_500.h5'
...
root_logdir = '/media/SSD/BearHouse-Person-Model/mylogsB5_500_r2' 
...
# model checkpoint
modelName = f'B5R2_Gender_500_{STEPS_PER_EPOCH}.h5'
...
model.save('./models/B5R2_Gender_500.h5')
